...
def safe_print(str):
    print(SPACER.join(str) + SPACER)

if __name__ == "__main__":
    if util.find_spec("pygame") is None:
        safe_print(ERROR_CHAR + "pygame missing, please install it with \"pip3 install pygame\" (you'll need pip3), or similar")
        sys.stdout.flush()
    else:
