...
end tactic.rewrite_search.metric.edit_distance.weight.svm

namespace tactic.rewrite_search.metric
open tactic.rewrite_search.metric.edit_distance.weight.svm

meta def weight.svm : ed_weight_constructor :=
  λ α δ, ⟨tactic.rewrite_search.metric.edit_distance.weight.svm.init, λ g, calculate_weights g⟩
